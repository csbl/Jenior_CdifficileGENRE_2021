...
png(filename='~/Desktop/repos/Jenior_Cdifficile_2019/results/figures/figure_2B.png', 
...
png(filename='~/Desktop/repos/Jenior_Cdifficile_2019/results/figures/figure_2C.png', 
    units='in', width=4, height=4, res=300)
par(mar=c(3,4,0.5,0.5), las=1, mgp=c(1.9,0.75,0), lwd=1.5)
