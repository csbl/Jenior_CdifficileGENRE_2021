...
# Flux sampling files
clinda_samples <- '~/Desktop/repos/Jenior_Cdifficile_2019/data/contextualized_iCdG709/riptide_highspore_maxfit/flux_samples.tsv'
strep_samples <- '~/Desktop/repos/Jenior_Cdifficile_2019/data/contextualized_iCdG709/riptide_lowspore_maxfit/flux_samples.tsv'
