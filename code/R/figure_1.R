...
box()
# mass imbalance
text(x=18, y=19.5, labels='10.74%', font=2, cex=1.1)
text(x=12, y=18.5, labels='No formula data', col='firebrick')
text(x=20, y=17.5, labels='12.33%', font=2, cex=1.1)
text(x=22, y=16.5, labels='15.3%', font=2, cex=1.1)
# free metabolites
text(x=5, y=14.5, labels='0.0%', font=2, cex=1.1)
text(x=81, y=13.5, labels='74.12%', font=2, cex=1.1)
text(x=6, y=12.5, labels='0.25%', font=2, cex=1.1)
text(x=7, y=11.5, labels='0.68%', font=2, cex=1.1)
# stoichiometry
text(x=90, y=9.5, labels='83.1%', font=2, cex=1.1)
text(x=71, y=8.5, labels='64.3%', font=2, cex=1.1)
text(x=76, y=7.5, labels='69.3%', font=2, cex=1.1)
text(x=7, y=6.5, labels='1.0%', font=2, cex=1.1)
# no gpr
text(x=31, y=4.5, labels='23.81%', font=2, cex=1.1)
text(x=94, y=3.5, labels='100%', font=2, cex=1.1, col='white')
text(x=32, y=2.5, labels='24.71%', font=2, cex=1.1)
text(x=94, y=1.5, labels='100%', font=2, cex=1.1, col='white')
par(xpd=TRUE)
text(x=-13, y=18, labels='Mass\nImbalanced\nReactions', cex=1.2)
text(x=-13, y=13, labels='Freely\nProduced\nMetabolites', cex=1.2)
text(x=-13, y=8, labels='Overall\nStoichiometric\nInconsistency', cex=1.2)
